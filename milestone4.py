...
dataset_path = "Fakejob_dataset.xlsx"  
...
'''
Work from home and earn ₹50,000 per week! No skills required.

We are hiring a Software Engineer with experience in Python and Django.

Apply now for the position of Data Analyst at Infosys, Bengaluru.
'''